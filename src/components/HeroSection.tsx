...
// PERFORMANCE: Optimized letter-by-letter using single state instead of 18 motion.spans
const LetterByLetter = memo(
  ({
    text,
    delay = 0,
    speed = 50,
...
LetterByLetter.displayName = "LetterByLetter";
...
const HeroSection = memo(() => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-dark">
      ...
      {/* PERFORMANCE: Reduced from 12 to 5 floating particles, CSS animation */}
      {[...Array(5)].map((_, i) => (
        <div
          key={i}
      ...
      <div className="container mx-auto px-8 relative z-[10]">
        <div className="flex flex-col items-center lg:items-start justify-center min-h-screen text-center lg:text-left">
          ...
          {/* AI CONTENT CREATOR — Letter by letter + forced ONE LINE */}
          <motion.div
            ...
            <motion.div
              ...
              className="w-6 sm:w-8 md:w-10 h-[1px] bg-gradient-to-r from-transparent to-primary/60 origin-left flex-shrink-0"
            />

            {/* AI CONTENT CREATOR - Letter by letter, whitespace-nowrap forces single line */}
            ...
            <motion.div
              ...
              animate={{ scaleX: 1 }}
              transition={{ duration: 0.5, delay: 0.5 }}
              className="w-6 sm:w-8 md:w-10 h-[1px] bg-gradient-to-l from-transparent to-primary/60 origin-right flex-shrink-0"
            />
          </motion.div>
